...
function Subscription() {
  return (
    <div className="pt-10 md:pt-20 p-10 md:p-16 lg:p-20 relative">
      <div className="relative rounded-tl-2xl md:rounded-tl-[100px] lg:rounded-tl-[150px] z-10 rounded-tr-2xl bg-[#f9f7fe] rounded-bl-2xl rounded-br-2xl shadow-lg gap-5 md:gap-10 lg:gap-20 p-6 md:p-10 flex flex-col justify-evenly">
