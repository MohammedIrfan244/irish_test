...
function Right() {
  return (
    ...
    <motion.div
      className='relative rounded-3xl w-4/5 shadow-lg p-7 transition duration-300 hover:scale-[1.01] hover:shadow-2xl bg-white'
    ...
    >
      ...
      <div className='absolute -bottom-3 right-1 lg:-right-2 bg-white rounded-2xl shadow-lg p-4 w-60 z-20 transition duration-300 hover:scale-[1.02] hover:shadow-2xl'>
