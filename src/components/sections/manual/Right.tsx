...
function Right() {
    return (
        <div className='flex justify-center items-center h-full'>
            <div className='relative rounded-3xl shadow-2xl p-7 transition duration-300 hover:scale-[1.01] hover:shadow-xl bg-white'>
                <div className='overflow-hidden w-96 relative z-10'>
